  ...
  return (
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="food.html"><div class="bg-white rounded-lg shadow-md p-6">
            ...
            <a href="food2.html"><div class="bg-white rounded-lg shadow-md p-6">
            ...
            <a href="food3.html"><div class="bg-white rounded-lg shadow-md p-6">

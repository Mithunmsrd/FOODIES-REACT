  ...
  return (
    ...
    <div class="bg-slate-300  p-8 rounded shadow-lg max-w-md w-full m-[40px]">
        ...
        <form action="/user register" method="POST">
            ...
            <a href="user_login.html" type="submit"  class="w-full bg-indigo-500 text-white px-4 py-2 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600 ml-[150px]">Register</a>
        </form>
        <p class="mt-4 text-sm text-center text-gray-600">Already have an account? <a href="user_login.html" class="text-indigo-500 hover:underline">Login here</a></p>
    </div>

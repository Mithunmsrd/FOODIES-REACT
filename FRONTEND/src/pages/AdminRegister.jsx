  ...
  return (
    ...
    <div class="bg-slate-300  p-8 rounded shadow-lg max-w-md w-full">
        ...
        <form action="#" method="POST">
            ...
            <a href="admin login.html" type="submit" class="w-full bg-indigo-500 text-white px-4 py-2 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600 ml-[150px]">Register</a>
        </form>
        <p class="mt-4 text-sm text-center text-gray-600">Already have an account? <a href="admin login.html" class="text-indigo-500 hover:underline">Login here</a></p>
    </div>
    </div>
    </div>
  )
